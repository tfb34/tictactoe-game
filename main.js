...
function renderBoard(){
	for(let i = 0;i<9;i++){
		document.getElementById("cell"+i).addEventListener("click", function(){playerMove(i)});//don't forget to change this function
	}
}
...
function playerMove(i){
	...
	if(Gameboard.cells[i].length > 0){
		...
		if(gameController.check4Win(currPlayer)){
			console.log("You won!");
			//display on screen, replay, remove click event
